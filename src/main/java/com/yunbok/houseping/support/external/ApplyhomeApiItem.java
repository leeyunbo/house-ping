...
/**
 * 청약Home API 일반 APT 응답 항목 DTO
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public record ApplyhomeApiItem(
    ...
    @JsonProperty("HOUSE_SECD") String houseTypeCode,
    @JsonProperty("SUBSCRPT_AREA_CODE_NM") String areaName,
    @JsonProperty("RCRIT_PBLANC_DE") String announceDate,
    @JsonProperty("RCEPT_BGNDE") String receiptStartDate,
    @JsonProperty("RCEPT_ENDDE") String receiptEndDate,
