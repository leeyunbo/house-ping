...
class SlackMessageFormatterTest {
    ...
    class FormatBatchSummary {
        ...
        void returnsSummaryWithCountAndList() {
            ...
            List<Subscription> subscriptions = List.of(
                    createSubscription("힐스테이트 강남", "서울"),
                    createSubscription("래미안 판교", "경기")
            );
    ...
    class FormatDailyReport {
        ...
        void formatsAllSectionsWhenDataExists() {
            ...
            Subscription newSub = createSubscription("안양역 센트럴", "경기");
        ...
        void showsNoRegisteredAlertWhenEmpty() {
            // given
            Subscription newSub = createSubscription("힐스테이트 송도", "인천");
            DailyNotificationReport report = new DailyNotificationReport(
                    List.of(),
                    List.of(),
                    List.of(newSub)
        ...
        void limitsNewSubscriptionsToFive() {
            // given
            List<Subscription> newSubs = List.of(
                    createSubscription("아파트1", "서울"),
                    createSubscription("아파트2", "서울"),
                    createSubscription("아파트3", "서울"),
                    createSubscription("아파트4", "서울"),
                    createSubscription("아파트5", "서울"),
                    createSubscription("아파트6", "서울"),
                    createSubscription("아파트7", "서울")
            );
            DailyNotificationReport report = new DailyNotificationReport(
                    List.of(),
                    List.of(),
        ...
        void showsSummaryCountsAtBottom() {
            ...
            DailyNotificationReport report = new DailyNotificationReport(
                    ...
                    List.of(createSubscription("신규1", "서울"), createSubscription("신규2", "경기"), createSubscription("신규3", "인천"))
            );
    ...
    private Subscription createSubscription(String houseName, String area) {
