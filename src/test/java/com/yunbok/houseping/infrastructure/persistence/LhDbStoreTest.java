...
@DisplayName("LhDbStore - LH DB 어댑터 (Fallback용)")
...
class LhDbStoreTest {
    ...
    private LhDbStore adapter;

    @BeforeEach
    void setUp() {
        adapter = new LhDbStore(subscriptionRepository);
    }
    ...
    class Fetch {
        ...
        void filtersLhSourceOnly() {
            ...
            // when
            List<Subscription> result = adapter.fetch(areaName, targetDate);
    ...
    class EntityMapping {
        ...
        void mapsLhSpecificFields() {
            ...
            Subscription info = result.get(0);
