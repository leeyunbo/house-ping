...
@DisplayName("LhWebAdapter - LH 웹 캘린더 어댑터")
@ExtendWith(MockitoExtension.class)
@org.mockito.junit.jupiter.MockitoSettings(strictness = org.mockito.quality.Strictness.LENIENT)
class LhWebAdapterTest {
    ...
    private LhWebAdapter adapter;

    @BeforeEach
    void setUp() {
        adapter = new LhWebAdapter(webClient);
    }
    ...
    class Fetch {
        ...
        void filtersNonMatchingArea() {
            ...
            // when
            List<SubscriptionInfo> result = adapter.fetch("부산", targetDate);
