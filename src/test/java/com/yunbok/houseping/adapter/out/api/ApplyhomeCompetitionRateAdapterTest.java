...
@DisplayName("ApplyhomeCompetitionRateAdapter - 경쟁률 API 어댑터")
@ExtendWith(MockitoExtension.class)
@org.mockito.junit.jupiter.MockitoSettings(strictness = org.mockito.quality.Strictness.LENIENT)
class ApplyhomeCompetitionRateAdapterTest {
    ...
    private ApplyhomeCompetitionRateAdapter adapter;

    @BeforeEach
    void setUp() {
        adapter = new ApplyhomeCompetitionRateAdapter(webClient, properties, "test-api-key");
