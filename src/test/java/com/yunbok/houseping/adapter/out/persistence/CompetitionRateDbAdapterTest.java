...
@DisplayName("CompetitionRateDbAdapter - 경쟁률 DB 어댑터")
@ExtendWith(MockitoExtension.class)
class CompetitionRateDbAdapterTest {
    ...
    private CompetitionRateDbAdapter adapter;

    @BeforeEach
    void setUp() {
        adapter = new CompetitionRateDbAdapter(repository);
    }
